...
async function segment(segtype){
  ...
  var url = "http://127.0.0.1:5000/"+segtype
  ...
  fetch(url, {
    ...
    img.src = "./segment.jpg?" + new Date().getTime();;
    var back_img = document.getElementById("back");
    back_img.src = "./masks/back.png?" + new Date().getTime();;
    img.onload= function(){
...
function selector(evt){
  if(bool_select==true){
    ...
    fetch(url, {
      ...
      img_1.src = "./segment.jpg?" + new Date().getTime();
      ...
      img_2.src = "./masks/col_"+colour_select+".png?" + new Date().getTime();
...
function inpaint_img(evt){
  ...
  fetch(url, {
    ...
    // img_1.src = "./segment.jpg"
    var img_1 = document.getElementById("output_img");
    img_1.src = "./inpaint.png?" + new Date().getTime();
    img_1.onload= function(){
      console.log("Painted");
    }
  })
